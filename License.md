...
당신은 아래의 a, b, c와 같은 행위를 해서는 아니된다:  
(a) 상표들 또는 이와 혼동을 일으킬 정도로 유사한 상표를 어떠한 관할권에서도 
    등록하거나 등록을 시도하는 행위;  
(b) 상표들에 관하여 라이선서 또는 정당한 사용자를 상대로 상표권을 주장하는 행위;  
(c) 상표들에 대한 소유권을 주장하는 소송을 제기하는 행위.  
  
당신이 제6조를 위반하는 경우, 본 라이선스에 따라 당신에게 부여된
모든 라이선스는 해당 위반일자를 기준으로 자동으로 종료된다.  
